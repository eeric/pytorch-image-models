...
## mark
There were many pre-trained models , and they had high precision. Multi-scale feature map of the middle layer could be obtained directly, which is suitable for classification task and object detection task.
